function outResults = crcbqcpso8(inParams,psoParams,nRuns)
%Regression of quadratic chirp using PSO . %3
%O = CRCBQCPPSO(I,P,N)
...
%sampFreq=512;
%4,inParams,sampFreq,psdVec,snr);
...
for lpruns = 1:nRuns   
    ...
    [estSig,~]=normsig4psd(estSig,inParams.sampFreq,inParams.psdVec,inParams.snr);
    %estAmp = inParams.dataY*estSig(:);
    estAmp = innerprodpsd(inParams.dataY,estSig,inParams.sampFreq,inParams.psdVec);
