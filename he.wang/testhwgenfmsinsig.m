...
hold;
plot(0:(1/HalfFreq):1.0,hwgenfmsinsig(0:(1/HalfFreq):1.0,A,f0,f1,b),'Marker','o','MarkerSize',14);
...
figure;
subplot(2,1,1);
plot(timeVec,sigVec);title('l6lab - the frequency modulated (FM) sinusoid signal');

subplot(2,1,2);
imagesc(T,F,abs(S)); axis xy;
xlabel('Time (sec)');
ylabel('Frequency (Hz)');
saveas(gcf,'l6lab_hwgenfmsinsig','png')