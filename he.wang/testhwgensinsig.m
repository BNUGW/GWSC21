...
hold;
plot(0:(1/HalfFreq):1.0,hwgensinsig(0:(1/HalfFreq):1.0,A,f0,phi0),'Marker','o','MarkerSize',14);
...
figure;
subplot(2,1,1);
plot(timeVec,sigVec);title('l6lab - the sinusoidal signal');

subplot(2,1,2);
imagesc(T,F,abs(S)); axis xy;
xlabel('Time (sec)');
ylabel('Frequency (Hz)');
saveas(gcf,'l6lab_hwgensinsig','png')